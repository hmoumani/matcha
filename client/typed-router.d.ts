...
declare module '@vue-router/routes' {
  export interface RouteNamedMap {
    ...
    'messagesS': RouteRecordInfo<'messagesS', '/chat', Record<never, never>, Record<never, never>>,
    ...
    'ss': RouteRecordInfo<'ss', '/matchProfile', Record<never, never>, Record<never, never>>,
    'messages': RouteRecordInfo<'messages', '/messages', Record<never, never>, Record<never, never>>,
    'profileS': RouteRecordInfo<'profileS', '/Profile', Record<never, never>, Record<never, never>>,
    ...
    'profile': RouteRecordInfo<'profile', '/user/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
